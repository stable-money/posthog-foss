...
# Shared base for delivery-channel UTM tracking params; each channel appends its own utm_medium.
UTM_TAGS_BASE = "utm_source=posthog&utm_campaign=ai_subscription_report"
